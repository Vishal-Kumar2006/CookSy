...
const FoodType = () => {
  const foodTypesDetails = [
    ...
    {
      image:
        "https://images.pexels.com/photos/1306548/pexels-photo-1306548.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      heading: "Gluten-Free",
      description:
    ...
    {
      image:
        "https://images.pexels.com/photos/31610385/pexels-photo-31610385/free-photo-of-artisan-breadsticks-with-fresh-micro-greens.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    ...
    {
      image:
        "https://images.pexels.com/photos/76227/pexels-photo-76227.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      heading: "Paleo",
      description:
  ...
  return (
    <div className="FoodType">
      ...
      <SlidingBlocks data={foodTypesDetails} type={"foodType"} />
    </div>
  );
};
