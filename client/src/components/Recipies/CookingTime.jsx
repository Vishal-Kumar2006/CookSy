...
const CookingTime = () => {
  const cookingTimesDetails = [
    {
      image:
        "https://media.istockphoto.com/id/1391222911/vector/five-minutes-icon-isolated-on-white-background-cooking-time-concept.jpg?s=612x612&w=0&k=20&c=pikS_J9Ms8NO8eq7IA3n96Edio-vCjEDQecgS5UY4lI=",
      heading: "5",
      description:
    ...
    {
      image:
        "https://media.istockphoto.com/id/1095986116/vector/ten-minutes-icon.jpg?s=612x612&w=0&k=20&c=kSn7HY7nD36M6Gizqpo8LlBRpHhsx0dSF4o-5w27A4A=",
      heading: "10",
      description:
    ...
    {
      image:
        "https://static.vecteezy.com/system/resources/previews/007/225/339/non_2x/20-timer-minutes-symbol-black-style-vector.jpg",
      heading: "20",
      description:
    ...
    {
      image:
        "https://static.vecteezy.com/system/resources/previews/007/224/668/non_2x/30-timer-minutes-symbol-black-style-vector.jpg",
      heading: "30",
      description:
    ...
    {
      image:
        "https://media.istockphoto.com/id/1337488470/vector/the-60-minutes-stopwatch-vector-icon-stopwatch-icon-in-flat-style-timer-on-on-color.jpg?s=612x612&w=0&k=20&c=-2YlW1sbzYg4QN-XHHvdQd2Yl7hYYIGJXaLUGMA2hxQ=",
      heading: "60",
      description:
    ...
    {
      image:
        "https://static.vecteezy.com/system/resources/previews/025/661/056/non_2x/2-hours-timer-symbol-black-color-vector.jpg",
      heading: "120",
      description:
  ...
  return (
    <div className="CookingTime">
      ...
      <SlidingBlocks data={cookingTimesDetails} type={"cookingTime"} />
    </div>
  );
};
